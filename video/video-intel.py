...
gcs_uri = "gs://hcls-jp1-video/flood/6182356-hd_1920_1080_30fps.mp4"
output_uri = "gs://hcls-jp1-video/flood/output-{}.json".format(time.time())

video_client = videointelligence.VideoIntelligenceServiceClient.from_service_account_file(
    "/home/user/nextflow/sa-nextflow.json")
