    ...
    <div className="patient-builder-container">
      ...
      <div className="frame">
        <div className="selection-section">
          <div className="header2">患者を選択</div>
        ...
        <div className="selection-section">
          ...
          このデモンストレーションでは、Gemini 2.5 Flashで動くAIが、MedGemmaという別のAIと会話します。
どちらのAIも、これから選ばれる病気の診断名は知らされていません。MedGemmaは、患者さんの症状を効率よく集めて整理するように作られています。また、このデモンストレーションでは、MedGemmaは患者の医療記録（FHIR形式）も見ることができます。
